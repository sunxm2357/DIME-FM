#!/bin/bash
#SBATCH --nodes=1
#SBATCH --job-name=nlp3m_small_datasets2_fullset_lp
...
MODE=linear_probe
CKPT=/checkpoints/sunxm/output/EfficientVLPTask/image_text_unpaired_v2/cc3m_nlp3m_offline-lr0.0008-wd0.05-bs4096-clip0.0-g8/clip_ViT-B32-cc3m-nlp3m-512-offline.yaml_conf~/run_3/152000/default/model_state_dict.pt
