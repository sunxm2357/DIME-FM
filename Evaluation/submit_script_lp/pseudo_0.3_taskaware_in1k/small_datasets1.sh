#!/bin/bash
#SBATCH --nodes=1
#SBATCH --job-name=vit_taskaware_pseudo_0.3_in1k_small_datasets1_fullset_lp
...
MODE=linear_probe
CKPT=/checkpoints/sunxm/output/EfficientVLPTaskNew/image_text_unpaired_v2/in21k-cc15m-yfcc14m-512-pseudo_mm_0.3-taskaware_in1k-lr0.0008-wd0.05-bs12288-clip0.0-g24/clip_ViT-B32-in21k-cc15m-yfcc14m-512-pseudo_mm_0.3_taskaware_in1k.yaml_conf~/run_1/324800/default/model_state_dict.pt
